...
class LTLayoutContainer(LTContainer):
    ...
    def group_objects(self, laparams, objs):
        ...
        for obj1 in objs:
            if obj0 is not None:
                ...
                #        (char_margin)
                halign = (
                    obj0.is_compatible(obj1) and obj0.is_voverlap(obj1) and (
                ...
                #   (line_overlap)
                valign = (
                    laparams.detect_vertical and obj0.is_compatible(obj1) and
    ...
    def group_textboxes(self, laparams, boxes):
        ...
        while dists:
            ...
            plane.remove(obj2)
            dists = [
                (lc, ld, lobj1, lobj2) for (lc, ld, lobj1, lobj2) in dists
                if lobj1 in plane and lobj2 in plane]
            for other in plane:
